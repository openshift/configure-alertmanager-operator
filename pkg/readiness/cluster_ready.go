...
// SAAP: This operator will get deployed only when the cluster is in Ready state.
// Therefore Clsuter will always be in Ready state.
...
func (impl *Impl) IsReady() (bool, error) {
	...
	log.Info("INFO: Cluster is in Ready State.")
	impl.ready = true
	return impl.ready, nil
