...
- `configure-alertmanager-operator-pull-request.yaml`: PR validation
- `configure-alertmanager-operator-push.yaml`: Main branch builds
- `configure-alertmanager-operator-pko-pull-request.yaml`: PKO validation
- `configure-alertmanager-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/configure-alertmanager-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: configure-alertmanager-operator-pull-request
Stage: golangci-lint
Error: Exit code 1
