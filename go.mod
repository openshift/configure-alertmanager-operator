...
require (
	...
	github.com/openshift/osde2e-common v0.0.0-20241004180659-1682f821fe5a
...
replace (
	...
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring => github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.80.1
