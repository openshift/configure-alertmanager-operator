...
const (
	...
	jUnitOutputFilename  = "junit-configure-alertmanager-operator.xml"
)

// Test entrypoint. osde2e runs this as a test suite on test pod.
func TestConfigureAlertmanagerOperator(t *testing.T) {
	RegisterFailHandler(Fail)

	suiteConfig, reporterConfig := GinkgoConfiguration()
	reporterConfig.JUnitReport = filepath.Join(testResultsDirectory, jUnitOutputFilename)
	RunSpecs(t, "Configure Alertmanager Operator", suiteConfig, reporterConfig)
