...
func createSubroutes(namespaceList []string, recieverType string) *alertmanager.Route {
	...
	if recieverType == "goalert"{
		...
		recieverDefault = receiverGoAlertLow
	...
	// 1. route anything we consider critical to recieverCritical
	// 2. route anything we want to silence to receiverNull
	// 3. route anything that should be a warning to recieverWarning
	// 4. route anything that should be an error to recieverError
	// 5. route anything we want to go to recieverCommon
	//
